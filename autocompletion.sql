...
(6, 'Aumônière brodée au griffon', , 'Broderie', '14e siècle', 'Classique', 'Musée de Cluny', 'https://www.musee-moyenage.fr/cache/media/oeuvres/aumonieres-de-la-comptesse-de-bar/aumoniere-de-la-comtesse-de-bar-1/s,900-db91b9.jpg'),
(7, 'Couronnes votives du trésor de Guarrazar', , 'Orfèvrerie', '7e siècle', 'Classique', 'Musée de Cluny', 'https://www.musee-moyenage.fr/cache/media/oeuvres/12-couronne-votive-guarrazar/cl_2879_3/s,900-fb964b.jpg'),
(8, 'Vitraux de la Sainte-Chapelle', , 'Vitrail', '13 siècle', 'Classique', 'Musée de Cluny', 'https://upload.wikimedia.org/wikipedia/commons/c/c4/SaintChapelle07.jpg'),
(9, 'Tapisseries de la Dame à la licorne', , 'Tapisserie', '15e - 16e siècle', 'Classique', 'Musée de Cluny', 'https://upload.wikimedia.org/wikipedia/commons/5/5f/Paris_-_Mus%C3%A9e_de_Cluny_-_La_Dame_%C3%A0_la_licorne_-_La_Vue_-_001.jpg'),
...
(15, 'la Cité radieuse', 'Le Corbusier', 'Architecture', '1947 - 1952', 'Moderne', 'Marseille', 'https://upload.wikimedia.org/wikipedia/commons/0/05/La_cit%C3%A9_radieuse_par_ryan_pellegrini.jpg'),
 ...
 (18, 'Voyage au centre de la Terre', 'Jules Verne', 'Livre', '1864', 'Roman d\'aventures', , 'https://upload.wikimedia.org/wikipedia/commons/b/b2/%27Journey_to_the_Center_of_the_Earth%27_by_%C3%89douard_Riou_38.jpg'),
(19, 'Balloon Dog', 'Jeff Koons', 'Sculpture', '1994 - 2000', 'Néo pop', , 'https://image.jimcdn.com/app/cms/image/transf/none/path/s33f4b296991f4cd1/image/i702a329bf06aae4e/version/1573915211/balloon-dog-orange-de-jeff-koons.jpg'),
(20, 'Suite bergamasque', 'Claude Debussy', 'Musique', '1890 - 1905', 'Baroque', , 'https://upload.wikimedia.org/wikipedia/commons/2/20/Clair_de_lune_Debussy.png'),
...
(40, 'Pierre du Soleil', 'Peuple Aztèque', 'Sculpture', '1479', 'Empire aztèque', 'Musée national d\'anthropologie de Mexico', 'https://upload.wikimedia.org/wikipedia/commons/1/14/Piedra_del_Sol_en_MNA.jpg'),
 ...
 (44, 'Dame blanche', 'Peuple bochiman', 'Peinture', 'il y a 2000 ans', , 'Namibie', 'https://upload.wikimedia.org/wikipedia/commons/5/56/Wei%C3%9Fe_Dame_Brandberg.JPG');
COMMIT;
